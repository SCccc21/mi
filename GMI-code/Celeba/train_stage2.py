...
if __name__ == "__main__":
	...
	# path_G = '/home/sichen/models/GAN/celeba_G_cross.tar'
	# path_D = '/home/sichen/models/GAN/celeba_D_cross.tar'
	...
	# path_G = '/home/sichen/models/improvedGAN/improved_mb_celeba_G_cross.tar'
	# path_D = '/home/sichen/models/improvedGAN/improved_mb_celeba_D_cross.tar'
	...
	for i in range(5):
		...
		for idx in range(5):
			print("--------------------- Attack batch [%s]------------------------------" % idx)
			# acc, acc5 = inversion(G, D, T, E, iden, itr=i, lr=2e-2, momentum=0.9, lamda=100, iter_times=1500, clip_range=1, improved=improved_flag)
			acc, acc5 = dist_inversion(G, D, T, E, iden, itr=i, lr=2e-2, momentum=0.9, lamda=100, iter_times=1500, clip_range=1, improved=improved_flag)
			iden = iden + 60
			total_acc += acc
			total_acc5 += acc5
