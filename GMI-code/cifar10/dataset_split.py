...
def cifar_eval(base_path):
	train = os.path.join(base_path, 'train_eval.txt')
	test = os.path.join(base_path, 'test_eval.txt')
...
if __name__ == '__main__':
	base_path = '/home/sichen/mi/GMI-code/cifar10/data/CIFAR_imgs'
	cifar_split(base_path)
	cifar_eval(base_path)
